...
export default function SEOHubPage() {
  ...
  const [llmsForm, setLlmsForm] = useState({
    site_name: 'Global Digital Prime',
    ...
    contact_email: 'hello@globaldigitalprime.com',
  ...
  const fetchAllData = useCallback(async () => {
    ...
    if (llmsData) {
      setLlmsForm({
        site_name: llmsData.site_name || 'Global Digital Prime',
      ...
      for (const kw of keywords.slice(0, 10)) {
        const response = await fetch('/api/seo/dataforseo', {
          ...
          body: JSON.stringify({
            action: 'rank_tracker',
            keyword: kw.keyword,
            target_domain: 'globaldigitalprime.com',
            location_code: 2548,
          }),
        });
...
## Social Media
- LinkedIn: /company/globaldigitalprime
- Facebook: /globaldigitalprime
