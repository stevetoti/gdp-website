...
export default function AdminSettingsPage() {
  ...
  const [videos, setVideos] = useState<VideoItem[]>([
    { id: '1', title: 'Welcome to Global Digital Prime', youtubeUrl: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ' },
  ...
  const loadSettings = async () => {
    setIsLoading(true);
    try {
      const settings = await getAllSettings('gdp');
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const success = await upsertSettings(settings, 'gdp');
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input
              ...
              placeholder="Global Digital Prime"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input
              ...
              placeholder="hello@globaldigitalprime.com"
              className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-deep-blue/20 focus:border-deep-blue"
            />
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input
              ...
              placeholder="https://facebook.com/globaldigitalprime"
              className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-deep-blue/20 focus:border-deep-blue"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              placeholder="https://linkedin.com/company/globaldigitalprime"
              className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-deep-blue/20 focus:border-deep-blue"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              placeholder="https://instagram.com/globaldigitalprime"
              className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-deep-blue/20 focus:border-deep-blue"
            />
          </div>
        </div>
      ...
      <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
        ...
        <div className="mb-6">
          ...
          <input
            ...
            placeholder="© 2026 Global Digital Prime. All rights reserved."
            className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-deep-blue/20 focus:border-deep-blue"
          />
        </div>
