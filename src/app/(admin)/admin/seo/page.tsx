...
export default function SEOSettingsPage() {
  const [settings, setSettings] = useState({
    ...
    siteTitle: 'Global Digital Prime',
    ...
    twitterHandle: '@globaldigitalprime',
    facebookUrl: 'https://facebook.com/globaldigitalprime',
    linkedinUrl: 'https://linkedin.com/company/globaldigitalprime',
  });
  ...
  useEffect(() => {
    async function loadSettings() {
      try {
        const data = await getAllSettings('gdp');
        ...
        setSettings({
          ...
          siteTitle: data[SEO_SETTINGS_KEYS.SITE_TITLE] || 'Global Digital Prime',
          ...
          twitterHandle: data[SEO_SETTINGS_KEYS.TWITTER_HANDLE] || '@globaldigitalprime',
          facebookUrl: data[SEO_SETTINGS_KEYS.FACEBOOK_URL] || 'https://facebook.com/globaldigitalprime',
          linkedinUrl: data[SEO_SETTINGS_KEYS.LINKEDIN_URL] || 'https://linkedin.com/company/globaldigitalprime',
        });
          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-50 rounded-lg p-4">
              ...
              <ol className="text-sm text-blue-800 space-y-2 list-decimal list-inside">
                ...
                <li>Create or select a property for globaldigitalprime.com</li>
